...
function App() {
  ...
  return (
    <main className='bg-slate-800 text-white min-h-screen px-3 sm:px-20'>
      {help ? 
      (
        <div className="fixed w-full h-screen bg-slate-800/60 flex flex-col justify-center items-center z-20 top-0 left-0 ">
		      <p className="overflow-y-auto bg-slate-400 text-black mb-24 w-3/4 xl:w-1/2 p-8 rounded-md text-lg border-gray-400 border-2 max-[600px]:text-sm max-[600px]:p-3 max-[600px]:w-full max-[600px]:mb-10">
      ...
      <div className='h-16  w-full text-right pt-7'>
        <button onClick={toggleHelp}
			  className="bg-gray-300 border-2 rounded-md text-black border-gray-700 hover:scale-90 ease-in-out duration-300 p-0.5 mt-0.5">
			  	<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="sm:w-[32px] sm:h-[32px] w-[24px] h-[24px]">
